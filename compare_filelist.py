...
def col_extract(col:int, file:str, separtor=",") : 
    with open(csvfile, "r") as f :
        ...
        if (len(lines[0]) == col) & (not file_list[-1].endswith("\n")) :
...
if __name__ == "__main__" :
    ...
    #==================================================#
    if input_mode == "csv" :
        filelist_1 = col_extract(col=1, csvfile=f"{root_dir}/{category_names[0]}.csv")
        filelist_2 = col_extract(col=1, csvfile=f"{root_dir}/{category_names[1]}.csv")
        total_filelist = col_extract(col=1, csvfile=f"{root_dir}/{category_names[2]}.csv")
